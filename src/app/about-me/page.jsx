  ...
  return (
    <div>
      ...
      <header className="text-center py-20">
        <h1 className="text-5xl md:text-7xl lg:text-9xl leading-relaxed"> About Me </h1>
      </header>

      {/* Image Section */}
      <section className="flex justify-center py-10">
        <div className="w-32 md:w-42 h-32 md:h-48 rounded-full overflow-hidden border-4 border-gray-300">
          <Image
            src="/photo.jpg"
            alt="Profile Picture"
            width={182}
